...
class Matlab(Package):
    ...
    def install(self, spec, prefix):
        ...
        # legacy_installer = join_path(
        #     self.stage.source_path, "bin", "glnxa64", "install_unix_legacy"
        # )

        # # Legacy installer is more stable until MathWorksInstaller is provided
        # if os.path.exists(legacy_installer):
        #     new_installer = join_path(self.stage.source_path, "bin", "glnxa64", "install_unix")
        #     os.remove(new_installer)
        #     os.rename(legacy_installer, new_installer)
